...
**lower bound : fist element greater than or equal to target**
**upper bound : first element greater than target**

### 2. Search Insert Position (LeetCode 35) - LOWER BOUND
> **Question:**
...
### 2. Find Smallest Letter Greater Than Target (LeetCode 744) - UPPER BOUND
