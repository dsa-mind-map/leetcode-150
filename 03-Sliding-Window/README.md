...
* **[Maximum Average Subarray I (643)](643-Maximum-Average-Subarray-I.md):** Find a contiguous subarray of exactly size $k$.
* **[Minimum Recolors to Get K Consecutive Black Blocks (2379)](2379-Minimum-Recolors-to-Get-K-Consecutive-Black-Blocks.md):** Look for a block of exactly $k$ consecutive elements.
* **[Substrings of Size Three with Distinct Characters (1876)](1876-Substrings-of-Size-Three-with-Distinct-Characters.md):** Window size locked to exactly 3.
* **[Minimum Difference Between Highest and Lowest of K Scores (1984)](1984-Minimum-Difference-Between-Highest-and-Lowest-of-K-Scores.md):** Evaluate chunks of exactly $k$ students.
* **[Permutation In String (567)](567-Permutation-In-String.md):** Permutations must match the exact length of the target string.
* **[Sliding Window Maximum (239)](239-Sliding-Window-Maximum.md):** Find the maximum in a sliding window of exactly size $k$.
...
* **[Longest Substring Without Repeating Characters (3)](3-Longest-Substring-Without-Repeating-Characters.md):** When a duplicate is found, the Tail squeezes forward until the duplicate is removed.
* **[Longest Repeating Character Replacement (424)](424-Longest-Repeating-Character-Replacement.md):** If the window contains more than $k$ non-matching characters, the Tail squeezes forward until back under the limit.
* **[Minimum Window Substring (76)](76-Minimum-Window-Substring.md):** Head expands until all target characters are found. The Tail then squeezes aggressively to make the window as small as possible without losing required characters.
...
* **[Best Time to Buy And Sell Stock (121)](121-Best-Time-to-Buy-And-Sell-Stock.md):** Tail tracks the lowest buy price. If Head finds a lower price, the old buy price is discarded, and the Tail snaps instantly to the Head.
* **[Longest Continuous Increasing Subsequence (674)](674-Longest-Continuous-Increasing-Subsequence.md):** Head expands as long as numbers increase. If the next number drops, the streak dies, and the Tail snaps to the Head to start a new streak.
